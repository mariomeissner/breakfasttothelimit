...
class Manager:
    ...
    def __init__(self):
        ...
        for i in range(self.num_users):
            ...
            start_time_hour = 15
            start_time_minute = 0
           start_time = start_time_hour*3600 + start_time_minute*60
            lamp = Lamp(i+1)
    ...
    def remaining_time(self, r):
        ...
        difference = roostart_time - (time_Seconds + int(travel_Time))
        return difference
...
class GMapsClient:
    ...
    def travel_time(self, destination):
        ...
        print("Requested travel takes " + str(duration) + "seconds")
        return duration
